...
$success = PhpMerger::generate([
    'destination' => $destDir . '/webp-on-demand-1.inc',
...
$jobsEverything = [
    [
        'root' => '../vendor/rosell-dk/webp-convert/src/',
        'dir-root' => '../vendor/rosell-dk/webp-convert/src',
        'files' => [
...
$success = PhpMerger::generate([
    'destination' => $destDir . '/webp-convert.inc',
    'jobs' => $jobsEverything
]);
if (!$success) {
    exit(255);
...
$success = PhpMerger::generate([
    'destination' => $destDir . '/webp-on-demand-2.inc',
    'jobs' => $jobsWod2
]);
if (!$success) {
    exit(255);
